...
import { HERO_BG_SRC, SKY_BG_SRC } from './assets/imagePaths';
  ...
  return (
    <>
      ...
      <header
        ...
        id="top"
        style={{
          backgroundImage: `url(${SKY_BG_SRC})`,
      ...
      >
        {/* Blend sky into dark compass background */}
        <div
          style={{
            position: 'absolute',
            inset: 0,
            zIndex: 0,
            background:
              'linear-gradient(to bottom, rgba(7,17,28,0.18) 0%, rgba(7,17,28,0.35) 50%, rgba(7,17,28,0.82) 72%, rgba(7,17,28,1) 88%)',
            pointerEvents: 'none',
          }}
        />
