...
export function TermsPage() {
  return (
    <PageLayout
      kicker="Legal"
      title="Terms of Use & Intellectual Property Notice"
      subtitle="Please review these terms before using this website."
      description="Terms of Use and intellectual property notice for NorthStar Implant Dentistry, P.C."
    >
      <div className="page-section">
        <p className="page-kicker">Last Updated</p>
        <p>[EDIT: insert publish date]</p>
      </div>

      <div className="page-section">
        <p className="page-kicker">About This Site</p>
        <h2>Ownership</h2>
        <p>
          This website (northstarimplants.com) is owned and operated by
          NorthStar Implant Dentistry, P.C. (&#8220;NorthStar,&#8221;
      ...
      <div className="page-section">
        <p className="page-kicker">Intellectual Property</p>
        <h2>Trademarks &amp; Copyright</h2>
        <p>
          All content on this site &#8212; including but not limited to text,
          graphics, the compass wheel navigation design, page layouts,
          photographs, and the overall look and feel &#8212; is the property
          of NorthStar Implant Dentistry, P.C. or its licensors, and is
          protected by U.S. copyright and trademark law.
        </p>
        <p>
          &#8220;NorthStar Implant Dentistry,&#8221; the NorthStar compass
          wheel design, and &#8220;Guiding Patients One Smile at a
          Time&#8221; are trademarks of NorthStar Implant Dentistry, P.C. Use
          of these marks without our prior written permission is prohibited.
        </p>
        <p>
          You may view and print pages from this site for your own personal,
          non-commercial use. You may not reproduce, republish, distribute,
          or create derivative works from any part of this site without our
          prior written consent.
        </p>
      </div>

      <div className="page-section">
        <p className="page-kicker">Patient Content</p>
        <h2>Photos and Testimonials</h2>
        <p>
          Before-and-after images and patient testimonials appearing on this
          site are used with the applicable patient&#8217;s consent. These
          images and testimonials remain the property of NorthStar Implant
          Dentistry, P.C. and may not be copied or reused.
        </p>
      </div>

      <div className="page-section">
        <p className="page-kicker">Important</p>
        <h2>No Medical Advice</h2>
        <p>
          Content on this site is provided for general informational purposes
          only and does not constitute dental or medical advice. It is not a
          substitute for a consultation with a qualified dental professional.
          Always seek the advice of your dentist or physician regarding any
          questions about a medical condition or treatment.
        </p>
      </div>

      <div className="page-section">
        <p className="page-kicker">Linked Sites</p>
        <h2>Third-Party Links</h2>
        <p>
          This site may link to third-party websites (e.g., patient portals,
          payment processors). We are not responsible for the content or
      ...
      <div className="page-section">
        ...
        <p>
          NorthStar Implant Dentistry, P.C. makes no warranties regarding the
          accuracy or completeness of information on this site and is not
          liable for any damages arising from your use of the site, to the
          fullest extent permitted by law. These terms are governed by the
      ...
      <div className="page-section">
        ...
        <h2>Reporting Infringement / Questions</h2>
        <p>
          If you believe content on this site infringes your rights, or if
          you have questions about these terms, contact us at:
        </p>
        <p>
          NorthStar Implant Dentistry, P.C.
          <br />
          [EDIT: practice mailing address]
          <br />
          [EDIT: email address]
          <br />
          <a href="tel:6313151400" style={{ color: '#f3d37a' }}>
            631-315-1400
          </a>
        </p>
      </div>
